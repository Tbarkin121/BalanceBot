...
#elif defined( SAMPLING_200Hz)
  #define DEFAULT_uhCCR1_Val 100
  #define ACCELERO_ODR  1666.0f    /* after filtering will be 93 Hz */
  #define ACCELERO_DIV LSM6DSM_ACC_GYRO_HPCF_XL_DIV9
  #define GYRO_ODR 208.0f
  #define MAGNETO_ODR 200.0f
  #define PRESSURE_ODR 50.0f
